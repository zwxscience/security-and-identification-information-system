<%@ Control Language="C#" AutoEventWireup="true" CodeFile="userfee.ascx.cs" Inherits="check_userfees" %>
...
<table style="width: 100%">
    ...
    <table style="width: 100%">
     <tr style="height:12pt">
         ...
         &nbsp;&nbsp;&nbsp;
             <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="报表下载" />
             </td>
    </tr>
     ...
     <Columns>
            <asp:BoundField DataField="id" HeaderText="标识ID" />
               ...
               <asp:BoundField DataField="ClientName" HeaderText="用户名" />
                ...
                <asp:BoundField DataField="count1" HeaderText="查询统计数" />
