...
<table style="width: 100%">
    ...
    <tr style="font-size: 12pt; font-family: Times New Roman; height: 12pt">
        <td style="width: 20%; height: 12pt;TEXT-ALIGN:   right ">
            <asp:Label ID="Lcaption" runat="server" Font-Size="10pt" Text="标题：" style= "TEXT-ALIGN:   right " ></asp:Label></td>
    ...
    <tr style="font-size: 12pt; font-family: Times New Roman; height: 12pt;">
        <td style="width: 20%; height: 12pt;TEXT-ALIGN:   right ">
            <asp:Label ID="CBdate" runat="server" Font-Size="10pt" Text="发布日期区间：" style= "TEXT-ALIGN:   right " ></asp:Label>
        </td>
        <td style="height: 12pt">
            <asp:TextBox
