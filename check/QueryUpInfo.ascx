<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QueryUpInfo.ascx.cs" Inherits="check_QueryUpInfo" %>
...
<table style="width: 100%">
    <tr style="height:20pt">
        ...
        <asp:Label ID="Label2" runat="server" Text="已上传图片查询" Font-Bold="True" 
    ...
    <tr style="height: 12pt">
        <td class="style1">
            ...
            <asp:TextBox ID="cpbh" runat="server" 
                ToolTip="请输入产品编号" Width="52%"></asp:TextBox></td>
        <td style="width: 50%; height: 12pt">
            &nbsp;</td>
    </tr>
    <tr style="height: 12pt">
        <td align=left class="style1" colspan="2" >
            <asp:Label ID="Lyz_jbr" runat="server" Text="查询日期区间：" Font-Size="10pt" style= "TEXT-ALIGN:   right "
                Width="100px"   ></asp:Label>
            <asp:TextBox ID="ksrq" runat="server" 
                Width="12%"　ToolTip="请输入开始日期，数字形式如：19870318" style="margin-left: 0px"></asp:TextBox>
            --<asp:TextBox 
                ID="jzrq" runat="server" 
                ToolTip="请输入截止日期，数字形式如：19870318" Width="12%"></asp:TextBox>
            </td>
    </tr>
     <tr style="height:12pt">
         <td align="center" colspan="2">
    ...
    <tr>
        ...
        <asp:GridView ID="QRInfo" runat="server" AllowSorting="True" AutoGenerateColumns="False"
            ...
            <Columns>
                 <asp:BoundField DataField="id" HeaderText="查询编号" />
                <asp:BoundField DataField="QRString" HeaderText="产品编号" />
                <asp:BoundField DataField="date" HeaderText="查询日期" />
        
                <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="UpPInfo.aspx?id={0}"    Text="详细》">
        ...
        <td colspan="2" align="right" style="height: 10px">
            <asp:Panel ID="Panel_jq" runat="server" Direction="LeftToRight" 
                ForeColor="#003399" Height="11px" HorizontalAlign="Right" Width="100%" 
                Visible="False">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
