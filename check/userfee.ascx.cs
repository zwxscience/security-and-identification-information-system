...
using System.Data;
public partial class check_userfees : System.Web.UI.UserControl
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ////string sqlstr = "select top 1 * from rateSet order by id desc";
        ////DataSet myds = dacon.getds(sqlstr);
        ////float SI = float.Parse(myds.Tables[0].Rows[0]["SIRate"].ToString());
        ////float BI = float.Parse(myds.Tables[0].Rows[0]["BIRate"].ToString());
        //SqlDataAdapter da = new SqlDataAdapter("SELECT id as '序号',month as '统计月份',	count1	as '查询统计数', Cost as '应付金额',pay as '实际支付',remain as '未结算',OpTime	as '更新日期' FROM userFees where ClientName='" + Session["username"] + "' ORDER BY id", conn);
        ...
        dt.Columns.Add("查询统计数", typeof(int));
