<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QueryInfo.ascx.cs" Inherits="check_QueryInfo" %>
...
<table style="width: 100%">
    <tr style="height:20pt">
        <td align="center">
        <asp:Label ID="Label2" runat="server" Text="提交信息查询" Font-Bold="True" 
                Font-Names="宋体" Font-Size="16pt"  ForeColor="MidnightBlue"></asp:Label>
       
        </td>
    </tr>
    <tr style="height:12px; background-color: #ffccff;font-size:10pt">
...
<table style="width: 100%">
    ...
    <tr style="height: 12pt">
     ...
     <tr style="height:12pt">
         ...
         &nbsp;&nbsp;&nbsp;
             <asp:Button ID="Button1" runat="server" Text="批量提交" onclick="Button1_Click" />
         </td>
    </tr>
    <tr>
        <td colspan="2" >
        ...
        <asp:GridView ID="QRInfo" runat="server" AllowSorting="True" AutoGenerateColumns="False"
            ...
            <Columns>
              <asp:BoundField DataField="id" HeaderText="申请表ID" />
                ...
                <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="ProcInfo.aspx?id={0}"    Text="详细》">
                  ...
                  <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="InfoMod.aspx?id={0}"    Text="修改》">
                    <ItemStyle Width="45pt" Font-Strikeout="False" />
                    <HeaderStyle Width="20px" />
                </asp:HyperLinkField>
                  <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="InfoDel.aspx?id={0}"    Text="删除》">
                    <ItemStyle Width="45pt" Font-Strikeout="False" />
                    <HeaderStyle Width="20px" />
                </asp:HyperLinkField>
            </Columns>
