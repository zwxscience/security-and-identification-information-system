<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QueryInfoC.ascx.cs" Inherits="query_SealInfo" %>
...
<table style="width: 100%">
    <tr style="height:20pt">
        ...
        <asp:Label ID="Label2" runat="server" Text="已通过审批信息查询" Font-Bold="True" 
...
<table style="width: 100%">
    ...
    <tr>
        ...
        <td colspan="2" align="right" style="height: 10px">
                ...
                Text="审批状态注释：3---受理通过，4--通过并生成二维码图像" Font-Size="10pt" ></asp:Label>
