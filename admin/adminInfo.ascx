<%@ Control Language="C#" AutoEventWireup="true" CodeFile="adminInfo.ascx.cs" Inherits="query_SealInfo" %>
    ...
    <tr>
        ...
        <td style="width:50%; height: 12pt;">
            <asp:Label ID="Label4" runat="server" Text="请输入原始密码：" Font-Size="10pt"  style= "TEXT-ALIGN:   right " 
                Width="122px" />
            <asp:TextBox ID="TextBox6"  MaxLength="50" TextMode="Password" runat="server"></asp:TextBox>
        </td>
        <td style="width:50%; height: 12pt;">
            &nbsp;</td>
        ...
        <td style="width:50%; height: 12pt;">
            ...
            <asp:TextBox  TextMode="Password"  MaxLength="50" ID="TextBox7" runat="server"></asp:TextBox>
        </td>
           <td style="width:50%; height: 12pt;">
               &nbsp;</td>
        </tr>
