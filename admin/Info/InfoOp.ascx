<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InfoOp.ascx.cs" Inherits="Info_InfoOp" %>
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(caption).autocomplete("InfoOp.ashx",
{
...
<table style="width: 100%">
    ...
    <tr style="font-size: 12pt; font-family: Times New Roman; height: 12pt">
        ...
        <td style="height: 12pt">
          ...
          <a href="InfoIssue.aspx"><img alt="点击添加新通知" height="20px" 
                src="../../images/add.png" width="20px" /></a> </td>
    </tr>
    <tr style="font-size: 12pt; font-family: Times New Roman; height: 12pt">
        <td style="width: 20%; height: 12pt">
        ...
        <td style="height: 12pt">
            <asp:TextBox
                ID="Infokssj" runat="server" Width="23%"></asp:TextBox>--<asp:TextBox
                    ID="Infojssj" runat="server" Width="28%"></asp:TextBox></td>
    </tr>
    <tr style="font-size: 12pt; font-family: Times New Roman; height: 12pt">
            ...
            <asp:GridView ID="Info" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <asp:BoundField DataField="MessagesId" HeaderText="标题ID" />
                    ...
                    <asp:BoundField DataField="visitcount" HeaderText="访问量" />
                                          <asp:HyperLinkField DataNavigateUrlFields="MessagesId" DataNavigateUrlFormatString="InfoRead.aspx?NewsId={0}"
                        Text="查看">
                    
                        <ItemStyle Font-Strikeout="False" Width="45pt" />
                        <HeaderStyle Width="20px" />
                    </asp:HyperLinkField>
                    <asp:HyperLinkField DataNavigateUrlFields="MessagesId" DataNavigateUrlFormatString="InfoUpdate.aspx?NewsId={0}"
                        Text="更新">
                      ...
                      <asp:HyperLinkField DataNavigateUrlFields="MessagesId" DataNavigateUrlFormatString="InfoDel.aspx?NewsId={0}"        Text="删除" >                    
                        <ItemStyle  width="45pt" />
                        <HeaderStyle width="20px" />
                    </asp:HyperLinkField>
                </Columns>
            </asp:GridView>
